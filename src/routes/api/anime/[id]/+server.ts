...
import { fetchTmdbTvDetails, fetchTmdbMovieDetails, lookupTmdbIdByImdbId, fetchMalId } from '$lib/server/services/tmdb.service';
...
export const GET: RequestHandler = async ({ params, url }) => {
    try {
        ...
        return json({
            ...
            seasons: details.seasons || (mediaType === 'movie' ? [{
                id: details.tmdbId,
                name: 'Movie',
                seasonNumber: 1,
                episodeCount: 1,
