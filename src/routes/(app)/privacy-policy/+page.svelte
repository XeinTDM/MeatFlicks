<div class="text-text-color container mx-auto p-8">
  <h1 class="text-primary-color mb-6 text-4xl font-bold">Privacy Policy</h1>
  <p class="mb-4">
    This Privacy Policy describes Our policies and procedures on the collection, use and
    disclosure of Your information when You use the Service and tells You about Your privacy
    rights and how the law protects You.
  </p>
  <h2 class="text-text-color mb-4 text-2xl font-semibold">
    Interpretation and Definitions
  </h2>
  <h3 class="text-text-color mb-2 text-xl font-medium">Interpretation</h3>
  <p class="mb-4">
    The words of which the initial letter is capitalized have meanings defined under the
    following conditions. The following definitions shall have the same meaning regardless of
    whether they appear in singular or in plural.
  </p>
  <h3 class="text-text-color mb-2 text-xl font-medium">Definitions</h3>
  ...
  <ul class="mb-4 list-inside list-disc">
    ...
    <li>
      ...
      Agreement) refers to MeatFlicks.
    </li>
    <li>
    ...
    <li>
      <strong>Website</strong> refers to MeatFlicks, accessible from
      <a href="https://www.meatflicks.com" class="text-primary-color hover:underline">
        https://www.meatflicks.com
      </a>
    </li>
    <li>
  ...
  <h3 class="text-text-color mb-2 text-xl font-medium">Types of Data Collected</h3>
  <h4 class="text-text-color mb-2 text-lg font-medium">Personal Data</h4>
  <p class="mb-4">
  ...
  <h4 class="text-text-color mb-2 text-lg font-medium">Usage Data</h4>
  ...
  <h4 class="text-text-color mb-2 text-lg font-medium">
  ...
  <h3 class="text-text-color mb-2 text-xl font-medium">Use of Your Personal Data</h3>
  ...
  <h3 class="text-text-color mb-2 text-xl font-medium">Sharing Your Personal Data</h3>
  ...
  <p class="mb-4">
    Please note that We may need to retain certain information when we have a legal obligation
  ...
  <h3 class="text-text-color mb-2 text-xl font-medium">Business Transactions</h3>
  <p class="mb-4">
    If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be
    transferred. We will provide notice before Your Personal Data is transferred and becomes
    subject to a different Privacy Policy.
  </p>
  <h3 class="text-text-color mb-2 text-xl font-medium">Law enforcement</h3>
  <p class="mb-4">
    Under certain circumstances, the Company may be required to disclose Your Personal Data if
    required to do so by law or in response to valid requests by public authorities (e.g. a
    court or a government agency).
  </p>
  <h3 class="text-text-color mb-2 text-xl font-medium">Other legal requirements</h3>
  <p class="mb-4">
  ...
  <h2 class="text-text-color mb-4 text-2xl font-semibold">Children's Privacy</h2>
  <p class="mb-4">
  ...
  <h2 class="text-text-color mb-4 text-2xl font-semibold">Links to Other Websites</h2>
  <p class="mb-4">
  ...
  <h2 class="text-text-color mb-4 text-2xl font-semibold">Contact Us</h2>
  <p class="mb-4">
    If you have any questions about this Privacy Policy, You can contact us:
  </p>
  <ul class="mb-4 list-inside list-disc">
    <li>By email: privacy@meatflicks.com</li>
  </ul>
</div>
